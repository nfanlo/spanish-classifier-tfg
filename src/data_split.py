...
def data_split(src_file, train_size=0.6, dev_size=0.2, test_size=0.2):
    ...
    return train_valid_test_split(df, target= 'sentiment',train_size=train_size, valid_size=dev_size, test_size=test_size)
...
def main():
    ...
    parser.add_argument('--train_size',
                        help="Percentage of the train set",
                        type=float,
                        default=0.6)

    parser.add_argument('--dev_size',
                        help="Percentage of the dev set",
                        type=float,
                        default=0.2)
    ...
    X_train, y_train, X_dev, y_dev, X_test, y_test = data_split(args.src_file, train_size=args.train_size, dev_size=args.dev_size, test_size=args.test_size)

...
from spanishclassifier.utils.cli import TrainingPipelineArguments, InferencingPipelineArguments

def build_model_extra_config(args: Union[TrainingPipelineArguments, InferencingPipelineArguments], split_name: str, dataset: DatasetDict) -> Dict:
